...
extends ISpec:
  ...
  "updateManyApplicationStateByReference should set the state in all selected applications and leave others untouched" in:
    val record: AgentApplication = tdAll.agentApplicationLlp.afterAgentDetailsComplete
    val record2: AgentApplication = tdAll.agentApplicationLlp.afterAgentDetailsComplete.copy(
    ...
    val record3: AgentApplication = tdAll.agentApplicationLlp.afterAgentDetailsComplete.copy(
