...
trait TdBase:
  ...
  def individualName: IndividualName = IndividualName("Test Name")

  lazy val individualProvidedDetailsId: IndividualProvidedDetailsId = IndividualProvidedDetailsId("individual-provided-details-id-12345")
